...
| **Status** | Vastgesteld |
| **Rationale** | Om [**P1**](#p1-informatieobjecten-zijn-in-samenhang-bruikbaar) te realiseren moeten ook <a>objecttypes</a> relateerbaar en herbruikbaar zijn in verschillende registraties. Daartoe rekenen we ook alle eigenschappen die bij dat <a>objecttype</a> horen |
