...
- Definitie van 'metadata' was te beperkend, nu breder opgesteld.
	- Michel: het woord 'andere' is misschien overbodig
	- ... hoe wordt 'registratie' hier bedoeld? 
	- Pano: zitten aspecten van beheer in, bv de SOR wordt een registratie, is net iets meer dan een dataset.
	- Paul: is de lijst uitputtend bedoeld? Pano: nee, een open lijst. Paul: dan moet je dat aangeven in de tekst. 'zoals' toevoegen.
	- Met die aanpassing is de definitie akkoord.
...
- U1 ter vaststelling
	...
	- Vastgesteld. 
- U2 is al vastgesteld, we hebben nog een opmerking in de Noot verwerkt; deze is veralgemeniseerd (was: opmerkingen worden terug gebracht naar MIM, nu naar relevante standaarden)
- U3 ter vaststelling
	- 'hiërarchische' nog toevoegen in de titel
	...
	- Niels: noot toevoegen aan U3 dat dit een aandachtspunt is. > Doen
	...
	- Lenart vraagt nog of we ook van plan zijn het model in deze paradigma's uit te drukken, of alleen zorgen dat het kan? 
	- Pano: het streven is om vanuit MIM ook LD te implementeren. > geen wijziging.
	- Voorstel: Met wijziging titel en toevoegen Noot van Paul U3 vaststellen
	- Lennart: ik ben ongelukkig met het voorbeeld
	- Pano: het is juist een goed voorbeeld
	- Lennart: zo lijkt het kritiek op de BAG dat ze proberen een document in een pand te modelleren. Het is geen document maar een documentverwijzing. 
	...
	- Linda. Voorstel toelichting: 'hoewel dit in de BAG bedoeld is als een documentverwijzing, is het op deze manier niet in samenhang met andere registraties te gebruiken'. 
	- Lennart: of een ander voorbeeld kiezen. 
	- Linda: vinden anderen dit ook? 
	- Michel: het is geen ideaal voorbeeld.
	- Pano: we kunnen ook een ander voorbeeld zoeken. Er komen een paar voorbeelden langs. 
	- Lennart: Afgezien van het voorbeeld is het uitgangspunt akkoord. 
- U4 ter vaststelling
	- Implicatie toegevoegd dat passende versioneringsstrategie nodig is ivm gerelateerde bestaande registraties en mappings tussen bestaande registraties en SOR. 
	- Lennart: moet er bij de implicaties nog iets bij over wat je dan moet doen als er iets wijzigt? 
	- Lennart: we proberen hier nog niet te zeggen hoe de versioneringsstrategie moet worden ingevuld
	- Michel: 'aanpasbaar' erbij zetten. uitbreidbaar, aanpasbaar en inkrimpbaar = flexibel. > doen
	...
	- Paul: moet er nog iets bij over beheer / versionering? Iets met x y z... > doen
	- Pano: zal ik toevoegen
	- Met deze wijzigingen vastgesteld
- U5 ter vaststelling
...
- P2 ter vaststelling
	...
	- Michel: gaat het ook over relaties, gegevens etc? D
	- Pano: ja, zal dit nog verduidelijken. 
	- Vastgesteld met deze aanpassing.
- P3 ter vaststelling
	- Pano: vorige keer niet echt bezwaren, maar wel een opmerking dat er ook gekeken zou moeten worden naar alternatieven wbt de modellering hiervan. Concreet via een stereotype of tagged value in MIM. Dit alternatief noemen we nu ook in de tekst. Vraag aan Lennart of dit voldoende is.
	...
	- Linda: tekst aanpassing voorstel: 'door middel van een meta aanduiding' of iets dergelijks.
	- Lennart: het uitgewerkte voorbeeld aanpassen (Lennart en Pano offline)
	- met tekst aanpassing en voorbeeld aanpassing vastgesteld
- P4 ter vaststelling
	- Pano: gekoppeld begrip niet nodig voor ieder element; aangescherpt voor welke informatiemodel-elementen geldt dat ze met minstens 1 begrip gekoppeld zijn. Als er niet minstens 1 begrip relatie is moet worden uitgelegd waarom niet. Verder relatie opgenomen naar MIM paragraaf waar dit uitgelegd wordt.
	...
	- Niels: 'kenmerksoort' hier vevangen door 'eigenschap' (staat er meerdere keren in)
	- vastgesteld met deze wijziging.

## Richtlijnen
- R1 ter vaststelling
	- Pano: R1 en R2 komen voort uit P3. Eerdere discussie leverde geen bezwaren op. Bij de implicaties staat dat we het nieuwe NEN 3610 modelleerpatroon hanteren. Bezwaren?
	- vastgesteld
- R2 ter vaststelling
	...
	- Pano: misschien nog niet helder genoeg inderdaad. R1 gaat over gegevens die over het informatieobject gaan. R2 gaat verder, je zou hele reeks van gebeurtenissen die tot de totstandkoming van informatie leidden, kunnen modelleren. Misschien kunnen we R1 en R2 samenvoegen.
	...
	- Pano: we gaan ze samenvoegen. Kunnen we deze dan vaststellen na de samenvoeging? Of willen jullie het nog een keer zien. Michel en Lennart? Anderen? 
	- Lennart: geef iedereen de kans te reviewen.
	- Pano voegt samen, dan opnieuw ter vaststelling.
- Oude richtlijn 2 over multiple inheritance is geschrapt
- R3 ter vaststelling
	...
	- Lennart: R3 is nu wel hard gesteld. Als je er van maakt 'we wachten op verduidelijking in MIM" kan ik ermee leven. Over de voorbeelden: of je een motor of een oog beschouwt als objecttype of niet hangt af van je beschouwingsniveau. 
